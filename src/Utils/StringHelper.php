...
class StringHelper
{
    ...
    public static function uuid()
    {
        return sprintf(
            ...
            mt_rand(0, 4095) | 0x4000, // 12 bits before the 0100 of (version) 4 for "time_hi_and_version"
            mt_rand(0, 0x3fff) | 0x8000, // 16 bits, 8 bits for "clk_seq" hi_res and low_res two most significant bits holds zero and one for variant DCE1.1
